...
if __name__ == '__main__':
    ...
    parser.add_argument('--report', type=str, help='directory of your images', required=True)
    parser.add_argument('--outfile', type=str, default='recover.out', help='outoput file')
